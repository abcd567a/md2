#!/bin/bash
VERSION=modesdeco2_x86_64_u18.04_20180429
...
echo -e "\e[1;32m...INSTALLING DEPENDENCY 3 of 4 (libudev-dev) ... \e[39m"
sleep 2
apt install -y libudev-dev

echo -e "\e[1;32m...INSTALLING DEPENDENCY 4 of 4 (netbase) ... \e[39m"
sleep 2
